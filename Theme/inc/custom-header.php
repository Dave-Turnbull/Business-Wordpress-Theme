 ...
 *
 * @uses wordpress_theme_header_style()
 */
function wordpress_theme_custom_header_setup() {
	add_theme_support(
		'custom-header',
		apply_filters(
			'wordpress_theme_custom_header_args',
			array(
				'default-image'      => '',
...
if ( ! function_exists( 'wordpress_theme_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see wordpress_theme_custom_header_setup().
	 */
